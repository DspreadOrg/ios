...
-(void)doTrade_CP:(NSInteger)timeout;
-(void)doTrade_CP:(NSInteger)keyIndex delays:(NSInteger)timeout;
-(void)doCheckCard_CP:(NSInteger) timeout;
-(void)doCheckCard_CP:(NSInteger) timeout keyIndex:(NSInteger) mKeyIndex;
-(void)updateEMVConfigByXml_CP:(NSString *)xmlStr;
-(void)updateEmvConfig_CP:(NSString *)emvAppCfg emvCapk:(NSString*)emvCapkCfg;
-(void)updateEmvAPPByTlv_CP:(EMVOperation)emvOperation appTlv:(NSString *)appTlv;
-(void)updateEmvCAPKByTlv_CP:(EMVOperation)emvOperation capkTlv:(NSString *)capkTlv;
-(void)updateEmvAPP_CP:(NSInteger )operationType data:(NSArray*)data  block:(void (^)(BOOL isSuccess, NSString *stateStr))updateEMVAPPBlock;
-(void)updateEmvCAPK_CP:(NSInteger )operationType data:(NSArray *)data block:(void (^)(BOOL isSuccess, NSString *stateStr))updateCAPKBlock;
//open quick emv
...
-(void)getIccCardNo: (NSString *)transactionTime frontLength:(NSInteger)frontLength backLength:(NSInteger)backLength;
...
-(void)sendCvmPin:(NSData *)pinStr isEncrypted:(BOOL)isEncrypted;
...
-(void)getMPOCPin:(NSInteger)encryptType keyIndex:(NSInteger)keyIndex maxLen:(NSInteger)maxLen typeFace:(NSString *)typeFace cardNo:(NSString *)cardNo data:(NSString *)data delay:(NSInteger)timeout withResultBlock:(void (^)(NSString *status, NSDictionary * result))getPinBlock;
-(void)sendMPOCPin:(NSData *)pin;
-(void)cancelMPOCPin;
